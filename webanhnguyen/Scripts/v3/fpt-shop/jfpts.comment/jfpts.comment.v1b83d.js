                                ...
                                "<ul class='fcm-login-sul'>",
                                    "<li>",
                                        "<a href='javascript:void(0);' title='' class='fcm-login-fb'>",
                                            "<img src='http://fptshop.com.vn/Content/Publishing/css/images/cmt/i_facebook.png?v=1' />",
                        ...
                        "<div class='fshop-cmt-col6'>",
                            "<p class='fshop-cmt-relate'>",
                                ...
                                "<span class='fshop-cmt-numlike' data-id='" + option.id + "'>",
                                    "<img src='http://fptshop.com.vn/Content/Publishing/Comment/img/icon-numlike.png'>",
...
var ToastFts = (function ($) {
    ...
    buildHtml = function (options) {
        ...
        if (options.type === 'Warning') {
            ...
            cssObj.img = 'http://fptshop.com.vn/Content/v3/images/icon_warning.png';
            cssObj.color = '#F7F7F7';
        }
...
(function (d) {
    ...
    js.src = "http://cdn.fptshop.com.vn/Content/all.js";
