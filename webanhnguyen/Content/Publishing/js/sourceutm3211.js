if (window.location.href.indexOf("masoffer") > 0) {
    ...
    if (getQueryParams("utm_source") != null) {
        utm_createCookie("srf_b686d28583fc", getQueryParams("utm_source") + "/#" + getQueryParams("utm_campaign"), 3);
    }
    else {
        if (typeof $.cookie('srf_b686d28583fc') == 'undefined' && document.referrer != "" && document.referrer.indexOf("fptshop.com.vn") < 0) {
            utm_createCookie("srf_b686d28583fc", document.referrer, 3);
        }
    }
}
